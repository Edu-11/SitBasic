    ...
    <main>
                ...
                <div class="ficha_producto">
                    <div class="row ficha_producto_Banco_Caballeria">
                        <div class="ficha_imagen">
                            <img src="./images/Sitbasic_11_ProdLicenciaBanco.jpg"n 
                                alt="Licencia de Banco o Silla plegables">
                        </div>
                        <div class="ficha_texto">
                            ...
                            <div class="ficha_cuerpo">
                                <p>
                                    Licencia para corte de un mecanismo de hierro y maderas de silla o banco.
                                    <br>
                                    Incluye manual de montaje junto con los planos acotados en milímetros de todas
                                    y cada una de las piezas, en formato PDF y formato técnico DXF para corte
                                    mecanizado.
                                </p>
                            </div>
                        </div>
        ...
        <section id="formulario_compra">
            ...
            <div class="Intro_datos">
              <form id="form" name="ProductoLicencia_form" class="formulario" method="post" action="FormularioPedidoControl.php">
