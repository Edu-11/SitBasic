    ...
    <main>
                    ...
                    <div class="row ficha_producto_Banco_Caballeria">
                        <div class="col-lg-6 col-md-12 col-sm-12 ficha_imagen">
                            <img src="./images/Sitbasic_10_ProdEstrSilla.jpg"
                                alt="Estructura de Silla Plegable">
                        </div>
                        <div class="col-lg-6 col-md-12 col-sm-12 ficha_texto">
                            <div class="ficha_titulo">
                                <h1>Mecanismo de Silla Plegable</h1>
                            </div>
                            <div class="ficha_cuerpo">
                                <p> Estructura plegable de hierro natural con un ancho de 30 cm. Para silla de entre 40
                                    y 60 cm. de ancho. Soporta un peso de unos 120 kilos.
                                    <br>
                                    ...
                                    posibles en función del uso que necesites.
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <section id="formulario_compra">
            ...
            <div class="Intro_datos">
              <form id="form" name="MecanismoSilla_form" class="formulario" method="post" action="FormularioPedidoControl.php">
